    ...
    if (step === 'view' && story) {
        return (
            <div className="min-h-screen pt-20 pb-32 px-4 md:px-8">
                ...
                {/* Sticky Action Bar */}
                <div className="fixed bottom-[76px] md:bottom-24 left-1/2 -translate-x-1/2 bg-bg-card/90 backdrop-blur-xl border border-border-color shadow-2xl rounded-full p-2 flex gap-2 z-50">
                    <button 
