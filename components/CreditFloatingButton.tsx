        ...
        <>
            ...
            {showPopup && (
                <>
                    ...
                    />
                    <div className="fixed bottom-36 right-4 z-50 bg-bg-card p-4 rounded-xl shadow-xl border border-border-color w-64 animate-in fade-in slide-in-from-bottom-4 duration-200">
