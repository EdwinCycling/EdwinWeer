...
export const VintageNewspaper: React.FC<Props> = ({ data, weatherData, onClose, lang }) => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-start justify-center bg-bg-page/80 backdrop-blur-sm p-4 overflow-y-auto pt-[calc(4rem+env(safe-area-inset-top))] print:p-0 print:bg-white print:static print:block">
            <style>
                {`
